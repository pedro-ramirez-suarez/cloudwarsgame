...
| **pilot-windows-smoke** | `pilot-windows-smoke` | docs | 31 | pilot-windows-smoke contains 31 docs files in JSON, Markdown. |
...
flowchart LR
  ...
  pilot_windows_smoke["pilot-windows-smoke\n31 files · docs"]
