# Modernization candidates & wavefront — pedro-ramirez-suarez-fluffy-system

Generated 2026-09-23T00:58:23.028Z · project index: rebuilt

## Clusters (what moves together)

| Cluster | Modules | Internal edges | Crossing edges | Isolation |
|---|---|---|---|---|
| 1 | `pilot-windows-smoke` | 0 | 0 | 1.00 |
...
| 1 | `pilot-windows-smoke` | 0 | 0 | nothing depends on it — safe to migrate in isolation |
